          ...
          <div className="footer-section">
            <div className="footer-logo">
              <div className="logo-main">
                <img src={logoImage} alt="Yuvocreations logo" />
