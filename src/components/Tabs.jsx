    ...
    <div className="tabs-wrap">
      ...
      <div className="tab-contents">
        ...
        <div className={`tab-content ${activeTab === "tab3" ? "show" : ""}`}>
          ...
          <p>
            ● Digital Marketing<br/> ● Social Media Marketing<br/> ● SEO (Search Engine
            Optimization)<br/> ● Content Writing<br/> ● PPC Advertising (Google & Meta Ads)<br/>
            ● Email Marketing<br/> ● Influencer Marketing<br/> ● Online Reputation Management
          </p>
        </div>
      </div>
    </div>
